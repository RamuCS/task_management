...
// Fetch all users from the database with roles
$query = "SELECT u.user_id, u.name, u.email, u.approval, u.role_id, r.role_name 
          FROM users u
          LEFT JOIN roles r ON u.role_id = r.role_id"; // Join users and roles tables
...
<body>
    ...
    <main class="content" id="main-content">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <!-- Save Button -->
            <button type="submit" name="update_roles" class="btn1 btn-primary mb-3">Save Roles</button>
            ...
            <table class="table">
                <thead>
                    <tr bgcolor='#CCCCCC'>
                        ...
                        <th>Name</th>
                        <th>Email</th>
                        <th>Role</th> <!-- This column will now display role names -->
                        <th>Status</th>
                        <th>Update</th>
                        <th>Edit</th>
                    </tr>
                ...
                <tbody>
                    ...
                    while ($res = mysqli_fetch_array($result)) {
                        ...
                        // Display the role name from the roles table
                        echo "<td>" . $res['role_name'] . "</td>"; // This will show the role name
